...
Package path after scaffold: shop/nooraholdings/app
...
- `ui/theme/Theme.kt` — uses NORHD naming → apply brand colors
- `ui/theme/Type.kt` — typography → customize if needed
- `NORHDApp.kt` — Application class (already renamed)
...
- `data/database/NORHDDatabase.kt` — Room DB
